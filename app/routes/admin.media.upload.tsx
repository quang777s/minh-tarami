                    ...
                    {files.map((fileWithPreview, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 space-y-1.5">
                          ...
                          {fileWithPreview.compressionProgress > 0 &&
                            fileWithPreview.compressionProgress < 100 && (
                              <div className="space-y-1">
                                <div className="text-xs text-muted-foreground">
                                  Compressing...{" "}
                                  {Math.round(
                                    fileWithPreview.compressionProgress
                                  )}
                                  %
                                </div>
                                <div className="h-1.5 w-full bg-secondary rounded-full overflow-hidden">
                                  <div
                                    ...
                                    style={{
                                      width: `${fileWithPreview.compressionProgress}%`,
                                    }}
                                  />
                                </div>
                              </div>
                          ...
                          {fileWithPreview.compressedSize > 0 && (
                            <div className="text-xs text-muted-foreground">
                              ...
                              Compressed:{" "}
                              {(
                                fileWithPreview.compressedSize /
                                1024 /
                                1024
                              ).toFixed(2)}
                              MB
